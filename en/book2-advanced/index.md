...
### Part I: The Skill System
1. [Built-in Slash Commands](./01-slash-commands.md) — /commit, /review, /plan and more
2. [Custom Skills](./02-custom-skills.md) — Writing your own slash commands
3. [Skill Composition](./03-skill-composition.md) — Chaining skills together

### Part II: The Agent System
4. [Sub-agents Explained](./04-subagents.md) — What they are and when to use them
5. [Agent Types Catalog](./05-agent-catalog.md) — 100+ specialized agents
6. [Parallel Agent Orchestration](./06-parallel-agents.md) — Running agents concurrently
...
11. [MCP Fundamentals](./11-mcp-basics.md) — What MCP is and why it matters
12. [Browser MCP](./12-browser-mcp.md) — Web browsing and scraping
13. [Database MCP](./13-database-mcp.md) — Direct database access
14. [Building Custom MCP Servers](./14-custom-mcp.md) — Your own integrations

### Part V: Context & Performance
15. [Context Window Management](./15-context-management.md) — Staying within limits
16. [Token Optimization](./16-token-optimization.md) — Reducing costs, maximizing output
